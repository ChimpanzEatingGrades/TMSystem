...
function CheckoutModal({ order, subtotal, onClose }) {
  // ✅ QR remains clean — branch not included
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
      <div className="bg-white rounded-xl p-6 max-w-md w-full relative">
        ...
        <h2 className="text-xl font-bold text-center mb-2">Present to Cashier</h2>
        ...
        {cart.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl border h-fit space-y-4">
              ...
              {/* ✅ Branch display inside summary too */}
              {branchName && (
                <p className="text-sm text-gray-500 mb-2">
                  <MapPin size={14} className="inline mr-1 text-yellow-500" />
