...
const StockOutModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (!selectedMaterial || !quantity || !performedBy) {
        throw new Error('Please select a material, enter quantity, and specify who performed this operation')
      }
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              required
              disabled={loading}
              placeholder="Enter name of person who performed this operation"
            />
          </div>
          ...
          <div className="flex justify-end space-x-3">
            ...
            <button
              ...
              disabled={loading || !selectedMaterial || !quantity || !performedBy}
            >
